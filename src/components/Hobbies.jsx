    ...
    <section id="about hobbies"   ref={ref}>
      <div className="py-12 sm:py-16 bg-gradient-to-t from-[#0a0f1e] to-[#1e40af] px-6 sm:px-12 flex items-center justify-center">
        <div
          ...
          `}
        >
          <h2 className="text-4xl font-bold text-center mb-6 text-gray-800 animate-fade-in-down">
            🎯 Things I Love To Do
          </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            {hobbies.map((hobby, index) => (
              <button
                ...
                className={`relative group p-5 rounded-xl shadow-lg transition-all duration-[1500ms] ease-in-out
                  ${
                ...
                `}
              >
                <div className="text-3xl mb-2 transition-transform group-hover:rotate-12 animate-pulse">
                  {hobby.icon}
                </div>
